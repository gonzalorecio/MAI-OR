...
for i =1:4
    ...
    results_scale_corners = [results_scale_corners s];
...
for i =1:4
    ...
    results_rot_corners = [results_rot_corners s];
...
for i =1:4
    ...
    results_blur_corners =[results_blur_corners s];
...
for i =1:4
    ...
    results_contrast_corners =[results_contrast_corners s];
...
for i = 1:4
    ...
    results_3D_corners = [results_3D_corners s];
